    ...
    for (int i = 5; i < llvm_line_cnt; ++i) {
        ...
        if (in_func && llvm_result[i].find('{') == std::string::npos) {
            if (llvm_result[i].find("alloca") != std::string::npos) {
                ...
                if(llvm_result[i].find("for_judge")!=std::string::npos){
                    in_for_judge=true;
                }
                else if(llvm_result[i].find("for_update")!=std::string::npos){
                    in_for_update=true;
                }
                ...
                if(llvm_result[i].find("for_body")!=std::string::npos&&in_for_judge){
                    in_for_judge=false;
                }
                else if(llvm_result[i].find("for_judge")!=std::string::npos&&in_for_update){
                    in_for_update=false;
                }
